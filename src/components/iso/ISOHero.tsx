        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[600px]">
          ...
          >
            ...
            <div className="space-y-4">
              <motion.h1
                ...
                className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent leading-tight"
              >
                ISO 9001
                <span className="block text-3xl lg:text-4xl text-primary font-medium mt-2">
                  Certificación 2015
                </span>
              </motion.h1>
            ...
            >
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-2 px-8 py-3 text-base font-medium hover:bg-muted"
              >
          ...
          >
            ...
            <div className="relative">
              {/* Glow Effect */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-primary/20 to-yellow-500/20 rounded-2xl blur-xl"
                animate={{
              ...
              >
                <Card className="w-full h-full bg-gradient-to-br from-background to-background border-2 border-primary/20 shadow-2xl overflow-hidden">
