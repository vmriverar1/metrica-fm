...
function StatCard({ label, value, icon, delay = 0 }: StatCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <Card className="p-6 text-center hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm border-gray-200/60 hover:border-[#E84E0F]/30">
        <motion.div
          whileHover={{ scale: 1.1 }}
          transition={{ type: "spring", stiffness: 400, damping: 10 }}
          className="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-[#E84E0F] to-[#FF6B35] rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow"
        >
        ...
        <motion.div
          ...
          className="h-0.5 bg-gradient-to-r from-[#E84E0F] to-[#FF6B35] mt-3 rounded-full"
        />
      </Card>
    </motion.div>
  )
