      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {items.map((item, index) => (
          <motion.div
            ...
            transition={{ delay: index * 0.1 }}
            className="flex items-center gap-3 p-4 bg-[#E84E0F]/5 rounded-lg border border-[#E84E0F]/20"
          >
            <div className="w-8 h-8 rounded-full bg-[#E84E0F] flex items-center justify-center flex-shrink-0">
            ...
            >
              <Card className="text-center h-full hover:shadow-xl transition-all duration-300 group">
                <CardHeader className="pb-4">
                  <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-[#E84E0F] to-[#FF6B35] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <Badge className="bg-[#E84E0F]/10 text-[#E84E0F] border-[#E84E0F]/20 font-semibold">
                      {reason.stat}
                    </Badge>
                  </div>
                </CardContent>
        ...
        >
          <Tabs defaultValue="benefits" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-white shadow-sm">
              <TabsTrigger 
                value="benefits" 
                className="data-[state=active]:bg-[#E84E0F] data-[state=active]:text-white font-medium"
              >
                Beneficios
              </TabsTrigger>
              <TabsTrigger 
