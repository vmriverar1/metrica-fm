  ...
  return (
    <section ref={sectionRef} className="relative py-24 bg-gradient-to-b from-background to-background/50 overflow-hidden">
      ...
      <style jsx>{`
        ...
        .image:hover img {
          box-shadow: 
            0 5.6px 4.4px rgba(0, 168, 232, 0.034),
            0 13.4px 10.6px rgba(0, 168, 232, 0.048), 
            0 25px 20px rgba(0, 168, 232, 0.06),
            0 44.6px 35.8px rgba(0, 168, 232, 0.072), 
            0 83.6px 66.8px rgba(0, 168, 232, 0.086),
            0 200px 160px rgba(0, 168, 232, 0.12);
        }
