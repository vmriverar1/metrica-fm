...
export const CategoryManager: React.FC<CategoryManagerProps> = ({
  ...
  const handleAddCategory = () => {
    ...
    const category: Category = {
      ...
      color: newCategory.color || '#E84E0F',
    ...
    setNewCategory({ name: '', description: '', color: '#E84E0F', status: 'active' });
                ...
                {allowColors && (
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        type="color"
                        value={newCategory.color || '#E84E0F'}
