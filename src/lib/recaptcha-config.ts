...
export const RECAPTCHA_CONFIG = {
  ...
  // Viene de Secret Manager vía apphosting.yaml: RECAPTCHA_SECRET_KEY
  // Sin fallback a propósito: un secreto en el código es un secreto publicado. Si falta la
  // variable, la verificación falla de forma visible en vez de usar una clave comprometida.
